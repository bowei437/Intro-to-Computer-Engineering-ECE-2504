...
-- F1	=>  Location: PIN_N6,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF HW3P2 IS
...
-- Equation(s):
-- \inst6~0_combout\ = (\B~input_o\ & ((\C~input_o\) # ((\D~input_o\ & \A~input_o\))))
